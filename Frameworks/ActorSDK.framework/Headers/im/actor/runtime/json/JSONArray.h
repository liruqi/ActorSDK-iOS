...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/runtime/runtime-shared/src/main/java/im/actor/runtime/json/JSONArray.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorRuntimeJsonJSONArray")
#ifdef RESTRICT_ImActorRuntimeJsonJSONArray
#define INCLUDE_ALL_ImActorRuntimeJsonJSONArray 0
#else
#define INCLUDE_ALL_ImActorRuntimeJsonJSONArray 1
#endif
#undef RESTRICT_ImActorRuntimeJsonJSONArray

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ARJSONArray_) && (INCLUDE_ALL_ImActorRuntimeJsonJSONArray || defined(INCLUDE_ARJSONArray))
#define ARJSONArray_
...
FOUNDATION_EXPORT ARJSONArray *create_ARJSONArray_init();

FOUNDATION_EXPORT void ARJSONArray_initWithJavaUtilCollection_(ARJSONArray *self, id<JavaUtilCollection> copyFrom);

FOUNDATION_EXPORT ARJSONArray *new_ARJSONArray_initWithJavaUtilCollection_(id<JavaUtilCollection> copyFrom) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONArray *create_ARJSONArray_initWithJavaUtilCollection_(id<JavaUtilCollection> copyFrom);

FOUNDATION_EXPORT void ARJSONArray_initWithARJSONTokener_(ARJSONArray *self, ARJSONTokener *readFrom);

FOUNDATION_EXPORT ARJSONArray *new_ARJSONArray_initWithARJSONTokener_(ARJSONTokener *readFrom) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONArray *create_ARJSONArray_initWithARJSONTokener_(ARJSONTokener *readFrom);

FOUNDATION_EXPORT void ARJSONArray_initWithNSString_(ARJSONArray *self, NSString *json);

FOUNDATION_EXPORT ARJSONArray *new_ARJSONArray_initWithNSString_(NSString *json) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONArray *create_ARJSONArray_initWithNSString_(NSString *json);

FOUNDATION_EXPORT void ARJSONArray_initWithId_(ARJSONArray *self, id array);

FOUNDATION_EXPORT ARJSONArray *new_ARJSONArray_initWithId_(id array) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONArray *create_ARJSONArray_initWithId_(id array);
...
#pragma pop_macro("INCLUDE_ALL_ImActorRuntimeJsonJSONArray")

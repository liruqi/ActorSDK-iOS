...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/runtime/runtime-shared/src/main/java/im/actor/runtime/json/JSONTokener.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorRuntimeJsonJSONTokener")
#ifdef RESTRICT_ImActorRuntimeJsonJSONTokener
#define INCLUDE_ALL_ImActorRuntimeJsonJSONTokener 0
#else
#define INCLUDE_ALL_ImActorRuntimeJsonJSONTokener 1
#endif
#undef RESTRICT_ImActorRuntimeJsonJSONTokener

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ARJSONTokener_) && (INCLUDE_ALL_ImActorRuntimeJsonJSONTokener || defined(INCLUDE_ARJSONTokener))
#define ARJSONTokener_
...
FOUNDATION_EXPORT void ARJSONTokener_initWithNSString_(ARJSONTokener *self, NSString *inArg);

FOUNDATION_EXPORT ARJSONTokener *new_ARJSONTokener_initWithNSString_(NSString *inArg) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONTokener *create_ARJSONTokener_initWithNSString_(NSString *inArg);

FOUNDATION_EXPORT jint ARJSONTokener_dehexcharWithChar_(jchar hex);
...
#pragma pop_macro("INCLUDE_ALL_ImActorRuntimeJsonJSONTokener")

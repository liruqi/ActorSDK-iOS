...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/runtime/runtime-shared/src/main/java/im/actor/runtime/json/JSONObject.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorRuntimeJsonJSONObject")
#ifdef RESTRICT_ImActorRuntimeJsonJSONObject
#define INCLUDE_ALL_ImActorRuntimeJsonJSONObject 0
#else
#define INCLUDE_ALL_ImActorRuntimeJsonJSONObject 1
#endif
#undef RESTRICT_ImActorRuntimeJsonJSONObject

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ARJSONObject_) && (INCLUDE_ALL_ImActorRuntimeJsonJSONObject || defined(INCLUDE_ARJSONObject))
#define ARJSONObject_

@class ARJSONArray;
@class ARJSONStringer;
@class ARJSONTokener;
...
/*!
 ...
 be skipped.
 */
- (instancetype)initWithARJSONObject:(ARJSONObject *)copyFrom
...
/*!
 ...
 <code>JSONObject</code>.
 */
- (instancetype)initWithARJSONTokener:(ARJSONTokener *)readFrom;
 ...
 */
- (ARJSONObject *)accumulateWithNSString:(NSString *)name
                                  withId:(id)value;
 ...
 */
- (ARJSONObject *)appendWithNSString:(NSString *)name
                              withId:(id)value;
...
/*!
 ...
 .
 */
- (ARJSONArray *)getJSONArrayWithNSString:(NSString *)name;
...
/*!
 ...
 .
 */
- (ARJSONObject *)getJSONObjectWithNSString:(NSString *)name;
...
/*!
 ...
 , or null otherwise.
 */
- (ARJSONArray *)optJSONArrayWithNSString:(NSString *)name;

/*!
 @brief Returns the value mapped by <code>name</code> if it exists and is a <code>JSONObject</code>
 , or null otherwise.
 */
- (ARJSONObject *)optJSONObjectWithNSString:(NSString *)name;
...
/*!
 ...
 @return this object.
 */
- (ARJSONObject *)putWithNSString:(NSString *)name
 ...
 */
- (ARJSONObject *)putOptWithNSString:(NSString *)name
                              withId:(id)value;
...
- (void)writeToWithARJSONStringer:(ARJSONStringer *)stringer;
...
/*!
 ...
 method returns "null".
 */
inline id ARJSONObject_get_NULL();
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT id ARJSONObject_NULL;
J2OBJC_STATIC_FIELD_OBJ_FINAL(ARJSONObject, NULL, id)
...
FOUNDATION_EXPORT ARJSONObject *create_ARJSONObject_init();

FOUNDATION_EXPORT void ARJSONObject_initWithJavaUtilMap_(ARJSONObject *self, id<JavaUtilMap> copyFrom);

FOUNDATION_EXPORT ARJSONObject *new_ARJSONObject_initWithJavaUtilMap_(id<JavaUtilMap> copyFrom) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONObject *create_ARJSONObject_initWithJavaUtilMap_(id<JavaUtilMap> copyFrom);

FOUNDATION_EXPORT void ARJSONObject_initWithARJSONTokener_(ARJSONObject *self, ARJSONTokener *readFrom);

FOUNDATION_EXPORT ARJSONObject *new_ARJSONObject_initWithARJSONTokener_(ARJSONTokener *readFrom) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONObject *create_ARJSONObject_initWithARJSONTokener_(ARJSONTokener *readFrom);

FOUNDATION_EXPORT void ARJSONObject_initWithNSString_(ARJSONObject *self, NSString *json);

FOUNDATION_EXPORT ARJSONObject *new_ARJSONObject_initWithNSString_(NSString *json) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONObject *create_ARJSONObject_initWithNSString_(NSString *json);

FOUNDATION_EXPORT void ARJSONObject_initWithARJSONObject_withNSStringArray_(ARJSONObject *self, ARJSONObject *copyFrom, IOSObjectArray *names);

FOUNDATION_EXPORT ARJSONObject *new_ARJSONObject_initWithARJSONObject_withNSStringArray_(ARJSONObject *copyFrom, IOSObjectArray *names) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ARJSONObject *create_ARJSONObject_initWithARJSONObject_withNSStringArray_(ARJSONObject *copyFrom, IOSObjectArray *names);

FOUNDATION_EXPORT NSString *ARJSONObject_numberToStringWithNSNumber_(NSNumber *number);

FOUNDATION_EXPORT NSString *ARJSONObject_quoteWithNSString_(NSString *data);

FOUNDATION_EXPORT id ARJSONObject_wrapWithId_(id o);
...
#pragma pop_macro("INCLUDE_ALL_ImActorRuntimeJsonJSONObject")

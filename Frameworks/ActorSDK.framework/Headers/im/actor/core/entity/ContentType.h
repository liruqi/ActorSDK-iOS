...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/core/core-shared/src/main/java/im/actor/core/entity/ContentType.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorCoreEntityContentType")
#ifdef RESTRICT_ImActorCoreEntityContentType
#define INCLUDE_ALL_ImActorCoreEntityContentType 0
#else
#define INCLUDE_ALL_ImActorCoreEntityContentType 1
#endif
#undef RESTRICT_ImActorCoreEntityContentType

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ACContentType_) && (INCLUDE_ALL_ImActorCoreEntityContentType || defined(INCLUDE_ACContentType))
...
typedef NS_ENUM(NSUInteger, ACContentType_Enum) {
  ...
  ACContentType_Enum_SERVICE_TOPIC = 22,
  ACContentType_Enum_SERVICE_ABOUT = 23,
  ACContentType_Enum_UNKNOWN_CONTENT = 24,
};
...
+ (ACContentType *)SERVICE_TOPIC;

+ (ACContentType *)SERVICE_ABOUT;
...
inline ACContentType *ACContentType_get_SERVICE_TOPIC();
J2OBJC_ENUM_CONSTANT(ACContentType, SERVICE_TOPIC)

inline ACContentType *ACContentType_get_SERVICE_ABOUT();
J2OBJC_ENUM_CONSTANT(ACContentType, SERVICE_ABOUT)
...
@compatibility_alias ImActorCoreEntityContentType ACContentType;

#endif


#pragma clang diagnostic pop
#pragma pop_macro("INCLUDE_ALL_ImActorCoreEntityContentType")

...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/core/core-shared/src/main/java/im/actor/core/network/api/ApiBroker.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorCoreNetworkApiApiBroker")
#ifdef RESTRICT_ImActorCoreNetworkApiApiBroker
#define INCLUDE_ALL_ImActorCoreNetworkApiApiBroker 0
#else
#define INCLUDE_ALL_ImActorCoreNetworkApiApiBroker 1
#endif
#undef RESTRICT_ImActorCoreNetworkApiApiBroker

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ACApiBroker_) && (INCLUDE_ALL_ImActorCoreNetworkApiApiBroker || defined(INCLUDE_ACApiBroker))
#define ACApiBroker_
...
FOUNDATION_EXPORT ACApiBroker *create_ACApiBroker_initWithACEndpoints_withACAuthKeyStorage_withACActorApiCallback_withBoolean_withInt_withInt_withInt_withACApiParserConfig_(ACEndpoints *endpoints, id<ACAuthKeyStorage> keyStorage, id<ACActorApiCallback> callback, jboolean isEnableLog, jint minDelay, jint maxDelay, jint maxFailureCount, ACApiParserConfig *parserConfig);
...
#if !defined (ACApiBroker_PerformRequest_) && (INCLUDE_ALL_ImActorCoreNetworkApiApiBroker || defined(INCLUDE_ACApiBroker_PerformRequest))
...
FOUNDATION_EXPORT void ACApiBroker_PerformRequest_initWithLong_withACRequest_withACRpcCallback_withLong_(ACApiBroker_PerformRequest *self, jlong rid, ACRequest *message, id<ACRpcCallback> callback, jlong timeout);

FOUNDATION_EXPORT ACApiBroker_PerformRequest *new_ACApiBroker_PerformRequest_initWithLong_withACRequest_withACRpcCallback_withLong_(jlong rid, ACRequest *message, id<ACRpcCallback> callback, jlong timeout) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ACApiBroker_PerformRequest *create_ACApiBroker_PerformRequest_initWithLong_withACRequest_withACRpcCallback_withLong_(jlong rid, ACRequest *message, id<ACRpcCallback> callback, jlong timeout);

J2OBJC_TYPE_LITERAL_HEADER(ACApiBroker_PerformRequest)

#endif

#if !defined (ACApiBroker_CancelRequest_) && (INCLUDE_ALL_ImActorCoreNetworkApiApiBroker || defined(INCLUDE_ACApiBroker_CancelRequest))
...
#if !defined (ACApiBroker_NetworkChanged_) && (INCLUDE_ALL_ImActorCoreNetworkApiApiBroker || defined(INCLUDE_ACApiBroker_NetworkChanged))
...
#if !defined (ACApiBroker_ForceNetworkCheck_) && (INCLUDE_ALL_ImActorCoreNetworkApiApiBroker || defined(INCLUDE_ACApiBroker_ForceNetworkCheck))
...
#pragma pop_macro("INCLUDE_ALL_ImActorCoreNetworkApiApiBroker")

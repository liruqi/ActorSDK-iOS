...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/core/core-shared/src/main/java/im/actor/core/util/JavaUtil.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorCoreUtilJavaUtil")
#ifdef RESTRICT_ImActorCoreUtilJavaUtil
#define INCLUDE_ALL_ImActorCoreUtilJavaUtil 0
#else
#define INCLUDE_ALL_ImActorCoreUtilJavaUtil 1
#endif
#undef RESTRICT_ImActorCoreUtilJavaUtil

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ACJavaUtil_) && (INCLUDE_ALL_ImActorCoreUtilJavaUtil || defined(INCLUDE_ACJavaUtil))
#define ACJavaUtil_
...
/*!
 @brief Unboxing long list
 @param list source list
 @return result
 */
+ (IOSLongArray *)unboxWithJavaUtilList:(id<JavaUtilList>)list;
...
FOUNDATION_EXPORT IOSLongArray *ACJavaUtil_unboxWithJavaUtilList_(id<JavaUtilList> list);
...
#pragma pop_macro("INCLUDE_ALL_ImActorCoreUtilJavaUtil")

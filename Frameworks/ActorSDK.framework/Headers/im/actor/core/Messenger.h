...
//  source: /Users/liruqi/Documents/github/actor-platform/actor-sdk/sdk-core/core/core-shared/src/main/java/im/actor/core/Messenger.java
//

@import j2objc;

#pragma push_macro("INCLUDE_ALL_ImActorCoreMessenger")
#ifdef RESTRICT_ImActorCoreMessenger
#define INCLUDE_ALL_ImActorCoreMessenger 0
#else
#define INCLUDE_ALL_ImActorCoreMessenger 1
#endif
#undef RESTRICT_ImActorCoreMessenger

#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"

#if !defined (ACMessenger_) && (INCLUDE_ALL_ImActorCoreMessenger || defined(INCLUDE_ACMessenger))
#define ACMessenger_
...
/*!
 ...
 @return promise
 */
- (ARPromise * __nonnull)blockUser:(jint)uid;
...
/*!
 @brief Get ViewModel of global application state
 @return view model of application state
 */
- (ACGlobalStateVM * __nonnull)getGlobalState;
...
- (ACPhoneBookContact *)getPhoneBookContactWithLong:(jlong)contactId;
...
/*!
 ...
 @return Command for execution
 */
- (id<ACCommand> __nullable)joinGroupViaLinkCommandWithToken:(NSString *)token;
...
/*!
 @brief Load Blocked users list
 @return promise
 */
- (ARPromise * __nonnull)loadBlockedUsers;
...
/*!
 ...
 @return Command for execution
 */
- (id<ACCommand> __nonnull)revokeIntegrationTokenCommandWithGid:(jint)gid;
...
/*!
 ...
 @return promise
 */
- (ARPromise * __nonnull)unblockUser:(jint)uid;
...
J2OBJC_STATIC_INIT(ACMessenger)
...
#pragma clang diagnostic pop
#pragma pop_macro("INCLUDE_ALL_ImActorCoreMessenger")
